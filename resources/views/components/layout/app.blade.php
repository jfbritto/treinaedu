        ...
        <aside
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                @if(auth()->user()->isSuperAdmin())
                    <a href="{{ route('super.dashboard') }}" @click="sidebarOpen = false" class="flex items-center gap-2 px-3 py-2.5 rounded-md text-sm hover:bg-white/10 transition {{ request()->routeIs('super.dashboard') ? 'bg-white/20' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                        Dashboard
                    </a>
                    <a href="{{ route('super.companies.index') }}" @click="sidebarOpen = false" class="flex items-center gap-2 px-3 py-2.5 rounded-md text-sm hover:bg-white/10 transition {{ request()->routeIs('super.companies.*') ? 'bg-white/20' : '' }}">
                    ...
                    <a href="{{ route('super.subscriptions.index') }}" @click="sidebarOpen = false" class="flex items-center gap-2 px-3 py-2.5 rounded-md text-sm hover:bg-white/10 transition {{ request()->routeIs('super.subscriptions.*') ? 'bg-white/20' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        Assinaturas
                    </a>
                    <a href="{{ route('super.payments.index') }}" @click="sidebarOpen = false" class="flex items-center gap-2 px-3 py-2.5 rounded-md text-sm hover:bg-white/10 transition {{ request()->routeIs('super.payments.*') ? 'bg-white/20' : '' }}">
                    ...
                    <a href="{{ route('super.plans.index') }}" @click="sidebarOpen = false" class="flex items-center gap-2 px-3 py-2.5 rounded-md text-sm hover:bg-white/10 transition {{ request()->routeIs('super.plans.*') ? 'bg-white/20' : '' }}">
                ...
                @if(auth()->user()->isAdmin())
                    ...
                    <a href="{{ route('subscription.show') }}" @click="sidebarOpen = false" class="flex items-center gap-2 px-3 py-2.5 rounded-md text-sm hover:bg-white/10 transition {{ request()->routeIs('subscription.show') ? 'bg-white/20' : '' }}">
                ...
                @if(auth()->user()->isEmployee())
                    ...
                    <a href="{{ route('employee.paths.index') }}" @click="sidebarOpen = false" class="flex items-center gap-2 px-3 py-2.5 rounded-md text-sm hover:bg-white/10 transition {{ request()->routeIs('employee.paths.*') ? 'bg-white/20' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l5.447 2.724A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/></svg>
                        Trilhas
                    </a>
