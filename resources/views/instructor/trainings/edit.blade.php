        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-5">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    <form method="POST" action="{{ route('instructor.trainings.update', $training) }}" class="space-y-5" id="training-form">
                        @csrf @method('PUT')
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="space-y-1 flex flex-col justify-end pb-0.5">
