                    ...
                    <div class="p-5 flex-1 flex flex-col gap-4">
                        ...
                        <div class="mt-auto">
                            <div class="flex justify-between text-xs text-gray-400 mb-1">
                                <span>Progresso</span>
                                <span class="font-medium text-primary">{{ $path->progress_percent }}%</span>
                            </div>
                            <div class="w-full bg-gray-100 rounded-full h-2">
                                <div class="h-2 rounded-full bg-primary transition-all" style="width: {{ $path->progress_percent }}%"></div>
                            </div>
                        </div>
