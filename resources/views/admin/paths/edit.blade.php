<x-layout.app title="Editar Trilha">
    ...
    <div class="mb-6">
        <a href="{{ route('paths.show', $path) }}" class="inline-flex items-center gap-1.5 text-sm text-gray-400 hover:text-gray-600 transition mb-3">
    ...
    <div class="max-w-2xl space-y-6">
        <form method="POST" action="{{ route('paths.update', $path) }}">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea id="description" name="description" rows="3"
                            class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary">{{ old('description', $path->description) }}</textarea>
                    </div>
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <input type="checkbox" name="active" value="1"
                            {{ old('active', $path->active) ? 'checked' : '' }}
            ...
            <div class="flex justify-end mt-6">
                <div class="flex items-center gap-3">
                    <a href="{{ route('paths.show', $path) }}" class="px-4 py-2.5 text-sm text-gray-600 hover:text-gray-800 transition">Cancelar</a>
                    <button type="submit"
