...
<head>
    ...
    <title>TreinaHub — Plataforma de Treinamentos Corporativos</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-xl font-bold text-gray-900">TreinaHub</span>
                </div>
    ...
    <section class="py-20 bg-brand-600">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-indigo-100 mb-10">
                Junte-se a empresas que já transformaram seus treinamentos corporativos com o TreinaHub.
            </p>
            <a href="{{ route('register') }}"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-white font-semibold">TreinaHub</span>
                </div>
                <p class="text-sm text-gray-400">
                    &copy; 2025 TreinaHub. Todos os direitos reservados.
                </p>
            </div>
        </div>
    </footer>
