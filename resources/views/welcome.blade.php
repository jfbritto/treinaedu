            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                @php
                    $features = [
                        ...
                        ['icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4', 'title' => 'Quizzes com IA', 'desc' => 'Gere avaliações automaticamente com inteligência artificial (Gemini). Quizzes por aula, módulo ou ao final do treinamento.', 'color' => 'purple'],
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-2xl shadow-xl border-2 border-brand-500 overflow-hidden relative">
                    ...
                    <div class="px-8 pb-8 space-y-3 text-sm text-gray-600">
                        ...
                        <div class="flex items-center gap-2"><svg class="w-4 h-4 text-brand-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg><strong>Quiz com IA (Gemini)</strong></div>
