                ...
                <div class="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl shadow-sm overflow-hidden text-white hover:shadow-lg transition-shadow">
                    <div class="p-8">
                        ...
                        <a href="https://wa.me/5528999743099?text=Ol%C3%A1%2C%20tenho%20interesse%20no%20plano%20Enterprise%20do%20TreinaEdu" target="_blank" rel="noopener"
                           class="mt-6 flex items-center justify-center gap-2 py-3 px-4 text-sm font-semibold text-white bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl transition">
